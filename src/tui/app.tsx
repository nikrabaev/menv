  ...
  return (
    <Box flexDirection="column" width={columns} height={rows}>
      ...
      {modalOpen ? (
        ...
        <Box flexGrow={1}>
          <Sidebar state={state} height={listHeight} width={sidebarWidth} />
          <MainPane store={store} height={paneHeight - 2} narrow={narrow} />
          {narrow ? null : <Inspector state={state} width={inspectorWidth} />}
        </Box>
      )}
